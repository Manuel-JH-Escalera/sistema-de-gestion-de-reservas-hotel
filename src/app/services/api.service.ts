...
export class APIService {
  ...
  createHotel(data: any): Observable<any> {
    return this.http
      .post(this.apiURL + '/hoteles', data)
      .pipe(retry(3), catchError(this.handleError));
  }

  updateHotel(id: number, data: any): Observable<any> {
    return this.http
      .put(this.apiURL + '/hoteles/' + id, data)
      .pipe(retry(3), catchError(this.handleError));
  }

  deleteHotel(id: number): Observable<any> {
    return this.http
      .delete(this.apiURL + '/hoteles/' + id)
      .pipe(retry(3), catchError(this.handleError));
  }
  //habitaciones
  ...
  createHabitacion(data: any): Observable<any> {
    return this.http
      .post(this.apiURL + '/habitaciones', data)
      .pipe(retry(3), catchError(this.handleError));
  }

  updateHabitacion(id: number, data: any): Observable<any> {
    return this.http
      .put(this.apiURL + '/habitaciones/' + id, data)
      .pipe(retry(3), catchError(this.handleError));
  }

  deleteHabitacion(id: number): Observable<any> {
    return this.http
      .delete(this.apiURL + '/habitaciones/' + id)
      .pipe(retry(3), catchError(this.handleError));
  }
  //usuarios
  ...
  updateUsuario(id: number, data: any): Observable<any> {
    return this.http
      .put(this.apiURL + '/usuarios/' + id, data)
      .pipe(retry(3), catchError(this.handleError));
  }
  ...
  updateReserva(id: number, data: any): Observable<any> {
    return this.http
      .put(this.apiURL + '/reservas/' + id, data)
      .pipe(retry(3), catchError(this.handleError));
  }

  deleteReserva(id: number): Observable<any> {
    return this.http
      .delete(this.apiURL + '/reservas/' + id)
      .pipe(retry(3), catchError(this.handleError));
  }
}
